...
map.getView().fit([-512321.807870, 7513716.571503, 1619802.174654, 10600522.934261], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de los departamentos del Perú</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (101 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado por el curso Cartografia y SIG<br />UPN 2025<br />Ing.Angheli Geraldine Carrion Rosales';
            }
